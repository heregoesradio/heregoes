...
* **Figure 1.** *Geolocation error from terrain parallax in a 500 m resolution GOES-West ABI image (250 x 250 pixels).*
...
### Demo
We consider a region of the GOES-West CONUS covering the Pacific Northwest. Summit locations of four mountains in the Cascade Range are targeted to track displacement by parallax: Mt. Rainier, Mt. St. Helens, Mt. Adams, and Mt. Hood.

![Before and after geolocation correction](./img/resampled-nav.gif "Before and after geolocation correction")
* **Figure 3.** *Mountaintop coordinates (circled in green) are navigated in the ABI image. After geolocation correction, the coordinates align with the displaced summit pixels in the original image.*
...
* **Figure 4.** *Mountaintop coordinates (circled in green) are navigated in the GOES-West ABI image. After orthorectification of the image, the summit pixels align with the displaced coordinates.*
