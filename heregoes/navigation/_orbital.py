...
# pyorbital uses WGS84, GOES-R uses GRS80 - they are practically identical
...
def _local_hour_angle(jdays2000, longitude, right_ascension):  # pragma: no cover
...
def _lmst(jdays2000, longitude):  # pragma: no cover
...
def gmst(jdays2000):  # pragma: no cover
...
def sun_ra_dec(jdays2000):  # pragma: no cover
...
def sun_ecliptic_longitude(jdays2000):  # pragma: no cover
...
def observer_position(jdays2000, lon, lat, alt):  # pragma: no cover
...
def get_alt_az(jdays2000, lon, lat):  # pragma: no cover
...
def get_observer_look(
    sat_lon, sat_lat, sat_alt, jdays2000, lon, lat, alt
):  # pragma: no cover
